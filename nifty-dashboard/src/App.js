...
function App() {
  ...
  // DAILY DATA
  useEffect(() => {
    fetch("https://deploy-vdiim.onrender.com/daily-summary?limit=20")
      .then((res) => res.json())
  ...
  // INTRADAY DATA
  useEffect(() => {
    fetch("https://deploy-vdiim.onrender.com/volatility?limit=300")
      .then((res) => res.json())
      .then((data) => {
  ...
  fetch(`https://deploy-vdiim.onrender.com/intraday-by-date?date=${selectedDate}`)
    .then((res) => res.json())
    .then((data) => {
      const formatted = data.map((d, i) => ({
        index: i,
  ...
  useEffect(() =>{
    fetch("https://deploy-vdiim.onrender.com/hypothesis-test")
    .then(res => res.json())
  ...
  useEffect(() => {
    fetch("https://deploy-vdiim.onrender.com/range-distribution")
    .then(res => res.json())
